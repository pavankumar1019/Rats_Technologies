...
<form class="row g-3 needs-validation" action="upload.php" method="post" enctype="multipart/form-data" novalidate>
  ...
  <div class="col-md-3">
    ...
    <input type="text" name="courseug" class="form-control" id="validationCustom03" >
    <div class="invalid-feedback">
  ...
  <div class="col-md-3">
    ...
    <input type="text" name="ugper" class="form-control" onkeypress="javascript:return isNumber(event)" id="validationCustom03" >
    <div class="invalid-feedback">
  ...
  <div class="col-md-3">
    ...
    <input type="text" name="coursepg" class="form-control"  id="validationCustom03" >
    <div class="invalid-feedback">
  ...
  <div class="col-md-3">
    ...
    <input type="text" name="pgper" class="form-control" onkeypress="javascript:return isNumber(event)" id="validationCustom03" >
    <div class="invalid-feedback">
