...
<body class="animsition">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">Adminndoe@example.com</span>
                                                </div>
                                            </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="desig" id="inputEmail3" placeholder=" Ex:- English Prof.." required>
    </div>
  </div>
  <div class="form-group row">
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    ?>
                                       <tr class="tr-shadow">
                                                ...
                                                <td class="desc"><?php echo $row["department"];?></td>
