                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-30">
                                    <h2>Add Gallery</h2><br>
                                <form action="gallery.php" method="post" enctype="multipart/form-data">
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Title:-</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="name" id="inputEmail3" placeholder="Title" required>
    </div>
  </div>
                                       ...
                                       <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <form action="delete_gallery.php" method="post" enctype="multipart/form-data">
